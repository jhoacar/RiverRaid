...
public class Jugador extends Objeto implements Personajes{
    ...
    public Jugador()
    {
        ...
        imagen = CargarImagen.loadImage("src/recursos/jugador/Jugador Frente.png");
        
    }
    /**
     * Metodo que me permite mover y evalua los extremos por si choca o no
     * @param IZQUIERDA un booleano que me indica si se mueve hacia la izquierda
    ...
    public boolean moverme(boolean IZQUIERDA,boolean DERECHA,int BORDE_IZQUIERDO,int BORDE_DERECHO)
    {
        ...
        {
            if(vivo)
            imagen = CargarImagen.loadImage("src/recursos/jugador/Jugador Izquierda.png");
        ...
        {
            if(vivo)
            imagen = CargarImagen.loadImage("src/recursos/jugador/Jugador Derecha.png");
    ...
    public void explosion() {
            if(!vivo)
                imagen = CargarImagen.loadImage("src/recursos/jugador/Explosion Jugador.jpg");
